...
class TestItemModel:
    ...
    def test_item_model_creation(self, db):
        ...
        item = ItemModel(
            name="Test Item", description="Test Description", price=99.99, quantity=10
        )
    ...
    def test_item_model_defaults(self, db):
        ...
        item = ItemModel(name="Minimal Item", price=49.99)
...
class TestItemCreateSchema:
    ...
    def test_item_create_valid(self):
        ...
        item = ItemCreate(
            name="Valid Item", description="Valid Description", price=99.99, quantity=10
        )
    ...
    def test_item_create_without_optional_fields(self):
        ...
        item = ItemCreate(name="Minimal Item", price=49.99)
